...
public class FormularioListaEncadeada extends JFrame implements ActionListener {
	public static ListaEncadeada<Cliente> cadastro;
	...
	public FormularioListaEncadeada() {
		...
		cadastro = new ListaEncadeada<Cliente>();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == btnIncluir) {
			cadastro.inserirComeco(new Cliente(txtValor.getText()));
			txtValor.setText("");
	...
	public static void main(String args[]) {
		new FormularioListaEncadeada().setVisible(true);
	}
