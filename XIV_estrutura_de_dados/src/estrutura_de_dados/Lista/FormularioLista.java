...
public class FormularioLista extends JFrame implements ActionListener {
	public static Lista<Cliente> cadastro;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == btnIncluir) {
			cadastro.inserir(new Cliente(txtValor.getText()));
			txtValor.setText("");
		...
		if(obj==btnMostrarPos)
			JOptionPane.showMessageDialog(null,cadastro.retornarObj(Integer.parseInt(txtNumMaximo.getText())));
		
		 if(obj==btnRemoverPos) 
			 cadastro.excluir(Integer.parseInt(txtNumMaximo.getText()));
	...
	public String listar() {
		...
		for(int i= 0; i <total; i++) 
			msg += cadastro.retornarObj(i).toString() + "\n";
		return msg;
	}
